...
<head>
	<meta charset="utf-8">
	<title>Rural Technology Cell</title>
...
<br><br>
	...
	<!--section class="events"-->
		...
		<div class="">			
			...
			<div class="col-md-7">					<h3>Prof. Partha Pratim Chakraborty</h3>
...
<!--section class="posts">
		<div class="container">
			<h2 style="text-align:center;background-color:lightblue;color:white;border-radius:6px;padding:2px;">Founding Members</h2>
			<article>
				<div class="pic"><img width="121" height="150" src="images/pbs.jpg" alt=""></div>
				<div class="info">
					<h3>Prof. P B S Bhdoria</h3>
					<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis quasi architecto beatae vitae dicta sunt explicabo. </p>
				</div>
			</article>
			<article>
				<div class="pic"><img width="121" src="images/evt.jpg" alt=""></div>
				<div class="info">
					<h3>Prof. EV Thomas</h3>
...
$('.slick').slick({
  ...
  fade: true,
  cssEase: 'linear'
  // nextArrow: '<span class="glyphicon glyphicon-arrow-left"></span>',
  //prevArrow: '<span class="glyphicon glyphicon-arrow-right"></span>',
	});
	</script>
